# Program 12 : Linked list (Basic Operations)
## Write a C program to perform the basic operations or functions in the linked list.
...
Number of nodes in the list (iterative) : 5

Number of nodes in the list (recursive) : 5

Enter the element to search (iterative) :800

Element 800 is in the position (iterative) : 5

Enter the element to search (recursive) :100

Element 100 is in the position (recursive) : 2

Sum of the datas in the linked list : 2500

Reverse of the linked list :   800  500  200  100  900
