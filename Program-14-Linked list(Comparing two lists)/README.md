# Program 14 : Linked list (Comparing two lists)
## Write a C program to check whether two linked lists are same or not.
...
List 2 :   900  100  200  500  800

The two Linked lists are same
