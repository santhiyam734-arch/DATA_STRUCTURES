# Program 11 : Linked list (Insertion, Creation and Print)
## Write a C program to Create a linked list, Inserting the elements at both head and tail and printing the linked list.
